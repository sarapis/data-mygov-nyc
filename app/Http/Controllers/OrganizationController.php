...
class OrganizationController extends Controller
{
    ...
    public function find($id)
    {
        ...
        return view('frontend.organization', compact('services','locations','organizations', 'taxonomys','service_name','service','organization','filter', 'organization_services', 'organization_projects', 'organization_peoples', 'organization_map', 'organization_expenses', 'expenses_sum'));
    }
